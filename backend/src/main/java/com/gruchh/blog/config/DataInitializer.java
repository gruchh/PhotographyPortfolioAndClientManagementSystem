...
import com.gruchh.blog.dto.ShootType;
import com.gruchh.blog.entity.*;
import com.gruchh.blog.repository.*;
...
public class DataInitializer {
    ...
    public void initializeData() {
        ...
        try {
            ...
            User client1 = users.get(1); // client1
            User client2 = users.get(2); // client2

            // 2. Create and save categories
            ...
            // 4. Create and save photo shoots
    ...
    private List<Photo> createSamplePhotos(Category category, PhotoShoot photoShoot, Set<Tag> tags) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            photo.setFileSize(2500000L + (i * 100000L)); // 2.5MB - 2.9MB
            photo.setImageWidth(1920 + (i * 100));
            photo.setImageHeight(1280 + (i * 50));
            photo.setUploadDate(LocalDateTime.now().minusDays(30 - i));
            photo.setIsPublic(i < 3); // First 3 photos are public
            photo.setIsFeatured(i == 0); // First photo is featured
